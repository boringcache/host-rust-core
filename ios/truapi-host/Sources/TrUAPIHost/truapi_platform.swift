...
public struct FfiConverterTypeSignRawReview: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SignRawReview {
        ...
        case 1: return .product(request: try FfiConverterTypeHostSignRawRequest.read(from: &buf), watermarked: try FfiConverterBool.read(from: &buf)
        )

        case 2: return .legacyAccount(request: try FfiConverterTypeHostSignRawWithLegacyAccountRequest.read(from: &buf), watermarked: try FfiConverterBool.read(from: &buf)
        )
    ...
    public static func write(_ value: SignRawReview, into buf: inout [UInt8]) {
        ...
        case let .product(request,watermarked):
            writeInt(&buf, Int32(1))
            FfiConverterTypeHostSignRawRequest.write(request, into: &buf)
            FfiConverterBool.write(watermarked, into: &buf)


        case let .legacyAccount(request,watermarked):
            writeInt(&buf, Int32(2))
            FfiConverterTypeHostSignRawWithLegacyAccountRequest.write(request, into: &buf)
            FfiConverterBool.write(watermarked, into: &buf)
