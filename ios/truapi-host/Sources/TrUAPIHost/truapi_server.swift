...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_truapi_server_checksum_method_hostcallbacks_worker_demand_changed() != 17213) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_local_storage_read() != 17510) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_local_storage_write() != 25245) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_truapi_server_checksum_method_hostcallbacks_local_storage_clear() != 58531) {
        return InitializationResult.apiChecksumMismatch
    }
