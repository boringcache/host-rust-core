...
`window.__HOST_API_PORT__` MessagePort. SDK calls and private permission checks
...
HTTP and WebSocket share the same TCP port. A disconnect requires reloading
the page. Production builds must omit the tag.
