...
pub const TRUAPI_WIRE_SCHEMA_HASH: &str = "2830dece45c2c86b";
...
/// Wire discriminants for `backend_list`.
pub const BACKEND_LIST: MethodIds = MethodIds {
    trait_id: 19,
    method_id: 1,
};
...
pub const WIRE_TABLE: &[WireEntry] = &[
    ...
    WireEntry {
        method: "backend_list",
        kind: WireKind::Request(BACKEND_LIST),
    },
];
